...
ALTER TABLE ORD_COMP ADD CONSTRAINT ORD_COMP_SUCURSAL_FK FOREIGN KEY ( ID_SUC ) REFERENCES SUCURSAL ( ID_SUC ) ;

ALTER TABLE PEDIDO ADD CONSTRAINT PEDIDO_CLIENTE_FK FOREIGN KEY ( ID_CLIENTE ) REFERENCES CLIENTE ( ID_CLIENTE ) ;

ALTER TABLE PEDIDO ADD CONSTRAINT PEDIDO_DELIVERY_FK FOREIGN KEY ( ID_DELIVERY ) REFERENCES DELIVERY ( ID_DELIVERY ) ;

ALTER TABLE PEDIDO ADD CONSTRAINT PEDIDO_F_HORA_FK FOREIGN KEY ( ID_F_HORA ) REFERENCES F_HORA ( ID_F_HORA ) ;

ALTER TABLE PEDIDO ADD CONSTRAINT PEDIDO_SUCURSAL_FK FOREIGN KEY ( ID_SUC ) REFERENCES SUCURSAL ( ID_SUC ) ;
...
ALTER TABLE RADIO_ENTREGA ADD CONSTRAINT RADIO_ENTREGA_SUCURSAL_FK FOREIGN KEY ( ID_SUC ) REFERENCES SUCURSAL ( ID_SUC ) ;
